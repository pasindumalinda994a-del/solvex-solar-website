    ...
    <section ref={sectionRef} className="w-full py-8 md:py-12 lg:py-16">
      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <div className="grid grid-cols-12 gap-2 md:gap-2 lg:gap-3">
          ...
          <div className="col-span-12 mb-8 md:mb-12 lg:mb-16">
            <div className="grid grid-cols-12 gap-2 md:gap-2 lg:gap-3 items-start">
              ...
              <div className="col-span-12 lg:col-span-6">
                ...
                >
                  Latest <span style={{ color: '#09DFAB' }}>News</span> & Insights
                </h2>
              </div>
          ...
          {/* Blog Post 1 - spans 12 columns on mobile, 6 on tablet, 4 on desktop */}
          <div ref={card1Ref} className="col-span-12 md:col-span-6 lg:col-span-4">
            <BlogCard
          ...
          {/* Blog Post 2 - spans 12 columns on mobile, 6 on tablet, 4 on desktop */}
          <div ref={card2Ref} className="col-span-12 md:col-span-6 lg:col-span-4">
            <BlogCard
          ...
          {/* Blog Post 3 - spans 12 columns on mobile, 6 on tablet, 4 on desktop */}
          <div ref={card3Ref} className="col-span-12 md:col-span-6 lg:col-span-4">
            <BlogCard
              image="/images/about-image-1.jpg"
              alt="Blog post"
              date="MARCH 5, 2024"
