          ...
          <div className="col-span-12 mb-8 md:mb-12 lg:mb-16">
            <div className="grid grid-cols-12 gap-2 md:gap-2 lg:gap-3 items-start">
              ...
              <div className="col-span-12 lg:col-span-6">
                ...
                >
                  Why Choose <span style={{ color: '#09DFAB' }}>Solvex Solar</span>
                </h2>
              </div>
              ...
              <div className="col-span-12 lg:col-span-6 flex items-start justify-end">
                ...
                >
                  <span className="pl-2">Experience the difference with our proven expertise, quality service, and commitment to your energy independence.</span>
                </p>
              </div>
            </div>
          </div>

          {/* Benefit Card 1 - spans 12 columns on mobile, 6 on tablet, 3 on desktop */}
          <div ref={card1Ref} className="col-span-12 md:col-span-6 lg:col-span-3">
            <div className="h-full p-6 md:p-8 rounded-md bg-[#DFFFEA]/50">
              ...
              >
                Certified professionals with years of experience ensure your solar system is installed to the highest standards.
              </p>
            </div>
          </div>

          {/* Benefit Card 2 - spans 12 columns on mobile, 6 on tablet, 3 on desktop */}
          <div ref={card2Ref} className="col-span-12 md:col-span-6 lg:col-span-3">
            <div className="h-full p-6 md:p-8 rounded-md bg-[#DFFFEA]/50 ">
              <div className="w-12 h-12 md:w-14 md:h-14 mb-4 md:mb-6 rounded-md flex items-center justify-center">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
              ...
              <p 
                className="text-md font-normal leading-normal tracking-tight text-black/80"
              >
                Reduce your energy bills significantly with high-efficiency solar panels and enjoy long-term savings on electricity costs.
              </p>
            </div>
          </div>

          {/* Benefit Card 3 - spans 12 columns on mobile, 6 on tablet, 3 on desktop */}
          <div ref={card3Ref} className="col-span-12 md:col-span-6 lg:col-span-3">
            <div className="h-full p-6 md:p-8 rounded-md bg-[#DFFFEA]/50">
              <div className="w-12 h-12 md:w-14 md:h-14 mb-4 md:mb-6 rounded-md flex items-center justify-center">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
              ...
              <p 
                className="text-md font-normal leading-normal tracking-tight text-black/80"
              >
                Comprehensive warranty coverage protects your investment with peace of mind for decades to come.
              </p>
            </div>
          </div>

          {/* Benefit Card 4 - spans 12 columns on mobile, 6 on tablet, 3 on desktop */}
          <div ref={card4Ref} className="col-span-12 md:col-span-6 lg:col-span-3">
            <div className="h-full p-6 md:p-8 rounded-md bg-[#DFFFEA]/50">
              <div className="w-12 h-12 md:w-14 md:h-14 mb-4 md:mb-6 rounded-md flex items-center justify-center">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
              ...
              <p 
                className="text-md font-normal leading-normal tracking-tight text-black/80"
              >
                Contribute to a sustainable future by reducing your carbon footprint with clean, renewable solar energy.
              </p>
            </div>
          </div>
